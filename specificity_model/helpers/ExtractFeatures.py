...
class ExtractFeatures:
    ...
    def generate_or_read_token_count_in_patent_docs(self,sentences,sent_type):
        if sent_type == 'i':
            ...
            file_path = 'combined_sent_counts.pickle'
        else:
    ...
    def extract_features(self,sent_type = 'i'):    # 'i' for instantiation, 's' for specifications, 'b' for both
        ...
        if sent_type == 'i':
            ...
            labels = self.instantiation_labels + self.specification_labels
            sents = self.instantiation_sents + self.specification_sents
            obj_fe = fe(sents)
            self.generate_or_read_token_count_in_patent_docs(self.specification_sents,sent_type)
...
class ReadFeatureFiles:
    def __init__(self):
        ...
        self.cb_folder_path = 'features/combined'
        self.test_folder_path = 'features/test'
    ...
    def check_if_features_available(self,sent_type='i'):
        if sent_type == 'i':
            ...
            folder_path = self.cb_folder_path
        elif sent_type == 't':
    ...
    def read_features(self):
        ...
        if self.check_if_features_available('b'):
            print('Combined Features found!')
            self.df_b,self.wf_b = self.read_files(sent_type='b')
        else:
            print('Combined Features not found! Generate them first.')  
        
        if self.check_if_features_available('t'):
            print('Combined Features found!')
            self.df_t,self.wf_t = self.read_files(sent_type='t')
        else:
            print('Test Features not found! Generate them first.')  